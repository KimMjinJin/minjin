        ...
        $(document).on("click", ".mailSDetiles", function() {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    detailmlSn = result.mlSn;
    	            console.log("detailmlSn >> ", detailmlSn);
    	            $("#detailBM").attr("data-mlsn", detailmlSn);
    	            console.log("detailBM data-mlsn >> ", $("#detailBM").data("mlsn"));
    	
    	            // 북마크 상태 업데이트
    	            let bookmarkElement = $(".bookmark[data-mlsn='" + mlSn + "']");
    	            let bookmarkDetail = $("#detailBM");
    	            bookmarkDetail.removeClass("active").css("color", "");
    	            if (bookmarkElement.hasClass("active")) {
    	                bookmarkDetail.css("color", "#ff9f43");
    	                bookmarkDetail.addClass("active");
    	            }
...
<!--                             <i class="ti ti-paperclip cursor-pointer me-2"></i>  -->
                            <i id="detailBM" data-mlsn = "" class="email-list-item-bookmark ti ti-star ti-sm cursor-pointer me-2 bookmark"></i>
